...
app.put('/api/savings/update/:goalId', async (req, res) => {
    ...
    } catch (err) { return res.status(500).json({ error: "Could not update savings goal." }); }
});
...
app.delete('/api/savings/delete/:goalId', async (req, res) => {
    ...
    } catch (err) { return res.status(500).json({ error: "Could not delete goal." }); }
});
...
app.get('/api/group/my-groups', async (req, res) => {
    ...
    try {
        ...
        return res.json(rows);
    } catch (err) { return res.status(500).json({ error: "Could not load groups." }); }
});
...
app.post('/api/group/create', async (req, res) => {
    ...
    } catch (err) { return res.status(500).json({ error: "Could not create plan." }); }
});
...
app.post('/api/group/join', async (req, res) => {
    ...
    } catch (err) { return res.status(500).json({ error: "Could not join plan." }); }
});
...
app.put('/api/group/update-member', async (req, res) => {
    ...
    } catch (err) { return res.status(500).json({ error: "Could not update numbers." }); }
});
...
app.put('/api/group/set-goal', async (req, res) => {
    ...
    } catch (err) { return res.status(500).json({ error: "Could not set goal." }); }
});
...
app.get('/api/group/plan/:groupId', async (req, res) => {
    ...
    } catch (err) { return res.status(500).json({ error: "Could not load plan." }); }
});
...
app.delete('/api/group/leave', async (req, res) => {
    ...
    } catch (err) { return res.status(500).json({ error: "Could not leave group." }); }
});
...
app.delete('/api/group/remove-member', async (req, res) => {
    ...
    } catch (err) { return res.status(500).json({ error: "Could not remove member." }); }
});

app.post('/api/group/contribute', async (req, res) => {
    const { groupId, userId, amount, note } = req.body;
    if (!groupId || !userId || amount == null) return res.status(400).json({ error: "Missing fields." });
    ...
    } catch (err) { return res.status(500).json({ error: "Could not add contribution." }); }
});
...
app.get('/api/group/contributions/:groupId', async (req, res) => {
    ...
    try {
        ...
        return res.json(rows);
    } catch (err) { return res.status(500).json({ error: "Could not load contributions." }); }
});
...
app.delete('/api/group/contribution/:contributionId', async (req, res) => {
    ...
    try {
        const [result] = await dbAsync.query(
            `DELETE FROM GroupContribution WHERE contribution_id = ?`, [contributionId]
        );
    ...
    } catch (err) { return res.status(500).json({ error: "Could not delete contribution." }); }
});
